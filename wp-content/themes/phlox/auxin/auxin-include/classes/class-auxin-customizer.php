...
class Auxin_Customizer{
    ...
    public function controls_style() {
        if ( is_rtl() ) {
            wp_enqueue_style( 'auxin-customizer-rtl',  ADMIN_CSS_URL . 'other/customizer-rtl.css', NULL, NULL, 'all' );
        } else {
            wp_enqueue_style( 'auxin-customizer',  ADMIN_CSS_URL . 'other/customizer.css', NULL, NULL, 'all' );
        }
    ...
    public function controls_script() {
        wp_enqueue_script( 'auxin-customizer', ADMIN_JS_URL . 'solo/customizer-controls.js' , array( 'jquery' ), NULL, true );
    }
    ...
    public function preview_init(){
        ...
        wp_enqueue_style( 'auxin-customizer-preview',  ADMIN_CSS_URL . 'other/customizer-preview.css', NULL, NULL, 'all' );
    }
            ...
            foreach ( $sections as $section ) {
                ...
                if( isset( $section['parent'] ) ){
                    ...
                    if( empty( $section['parent'] ) ){
                        ...
                        $wp_customize->add_section( new Auxin_Customize_Section( $wp_customize, $section['id'], array(
                            'title'           => $section['title'],
                            'description'     => $section['description'],
