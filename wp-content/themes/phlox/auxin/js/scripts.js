    ...
    $(function(){
        ...
        if( $.fn.select2 ){
            ...
            // other pages
                ...
                $(document).on('panelsopen', function(){
                    select2_args_multi.dropdownParent = $('.auxin-admin-widget-wrapper');
                   $( select2_picker ).select2( select2_args );
                });
            }
        ...
        (function($){
            ...
            var rate            = $rating.filter(':checked').val(),
            $feedback_section   = $('.aux-feedback-section'),
            $feedback_form      = $('.aux-feedback-form'),
