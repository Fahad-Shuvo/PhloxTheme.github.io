...
function auxin_metabox_fields_general_slider(){
    ...
    $model->fields= array(
        ...
        array(
            ...
            'description'   => __('Please select the slider you want to display at top of the page.<br/>Revolution Slider Items are marked by [revo], Layer slider by [layer].', 'phlox'),
            'id'            => 'top_slider_id',
