...
function auxin_define_options_info( $fields_sections_list ){
    ...
    $options[] = array(
        ...
        'description'    => __( 'Specifies the max width of logo image in pixel.', 'phlox' ),
    ...
    $options[] = array(
        ...
        'description' => __( 'If you enable this option, pages animate when user navigates between pages.', 'phlox' ),
    ...
    $options[] = array(
        ...
        'description' => __( 'If you enable this option, the page images preload before they appear', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'Use custom loading', 'phlox' ),
        'description' => __( 'Enable this option to insert custom loading for the page.', 'phlox' ),
    ...
    $options[] = array(
        ...
        'description' => __( 'Select an animated gif to appear as page loading.', 'phlox' ),
    ...
    $options[] = array(
        ...
        'description' => __( 'It adds a progress bar to top side of the page which progresses while loading page assets.', 'phlox' ),
    ...
    $options[] = array(
        ...
        'style_callback' => function( $value = null ){
            if( ! $value ){
                $value = esc_attr( auxin_get_option( 'site_content_background_color' ) );
            }
            return empty( $value ) ? '' : ".aux-top-header, .aux-sticky-footer .page-title-section, .aux-sticky-footer #main,
            .site-header-section, #inner-body { background-color:$value; }";
        },
        'transport' => 'postMessage',
        'default'   => ''
    );
    ...
    $options[] = array(
        ...
        'description' => __( 'Enable this option to add a frame around the pages. ', 'phlox' ),
        'id'          => 'site_frame_show',
    ...
    $options[] = array(
        ...
        'description' => __( 'Specifies the color of the frame around the pages.', 'phlox' ),
        'section'     => 'appearance-section-frame',
        'type'        => 'color',
        'dependency'  => array(
            array(
...
/* ---------------------------------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------------------------------- */
    ...
    $options[] = array(
        ...
        'description' => __( 'Specifies the color scheme of header menu while the menu is on sticky mode.', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'Sticky Header Background Color', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'Header Menu Layout', 'phlox' ),
        'description' => __( 'Show menu vertical or horizontal', 'phlox' ),
        'id'          => 'site_header_navigation_layout',
        ...
        'transport'   => 'refresh',
        'choices'     => array(
            'horizontal' => __( 'Horizontal', 'phlox' ),
            'vertical'   => __( 'Vertical', 'phlox' )
        ),
    );
    ...
    $options[] = array(
        ...
        'id'          => 'site__vertical_header_search_border',
        'section'     => 'header-section-main-nav',
        'dependency'  => array(
            array(
                'id' => 'site_header_navigation_layout',
    ...
    $options[] = array(
        'title'       => __( 'Vertical Menu Footer', 'phlox' ),
        'description' => __( 'Show vertical menu footer or not.', 'phlox' ),
        'id'          => 'vertical_menu_footer_display',
        'section'     => 'header-section-main-nav',
        'dependency'  => array(
            array(
                 'id'      => 'site_header_navigation_layout',
    ...
    $options[] = array(
        'title'       => __( 'Vertical Menu Socials', 'phlox' ),
        'description' => __( 'Show Social icons in vertical menu footer.', 'phlox' ),
        'id'          => 'vertical_menu_socials',
        'section'     => 'header-section-main-nav',
        'dependency'  => array(
            array(
                 'id'      => 'site_header_navigation_layout',
    ...
    $options[] = array(
        'title'       => __( 'Vertical Menu Social Icon Size', 'phlox' ),
        'description' => __( 'Specifies the size of icons on vertical menu', 'phlox' ),
        'id'          => 'site_vertical_header_social_icon',
        'section'     => 'header-section-main-nav',
        'dependency'  => array(),
        'default'     => 'small',
        'type'        => 'select',
    ...
    $options[] = array(
        'title'       => __( 'Vertical Menu copyright text', 'phlox' ),
        'description' => __( 'Show copyright text in vertical menu footer.', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'Use Indicator', 'phlox' ),
        'description' => __( 'Enbale it to show indicator for open the submenu', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'TopHeader Submenu Skin', 'phlox' ),
        'description' => __( 'Specifies submenu skin.', 'phlox' ),
    ...
    $options[] = array(
        ...
        'style_callback' => function( $value = null ){
            if( ! $value )
                $value = esc_attr( auxin_get_option( 'site_top_header_background_color' ) );
    ...
    $sections[] = array(
        'id'          => 'header-section-fullsscreen-search',
        'parent'      => 'header-section', // section parent's id
    ...
    $options[] = array(
        ...
        'section'     => 'header-section-fullsscreen-search',
        'default'     => '',
        'type'        => 'radio-image',
        'transport'   => 'postMessage',
    ...
    $options[] = array(
        ...
        'dependency'  => '',
        'transport'   => 'postMessage',
        'post_js'     => '$(".single-post .aux-primary .entry-main > .entry-meta").auxToggle( to );',
        'default'     => '1',
        'type'        => 'switch'
    );
    ...
    $options[] =    array(
        'title'       => __( 'Display Post Title', 'phlox' ),
        ...
        'transport'   => 'postMessage',
        'post_js'     => '$(".single-post main .entry-main > .entry-header").toggle( to );',
        'type'        => 'switch',
        'default'     => '1'
    );
    ...
    $options[] = array(
        ...
        'type'        => 'switch',
        'transport'   => 'postMessage',
        'post_js'       => '$(".aux-archive .post .entry-main > .entry-info").auxToggle( to );',
        'default'     => '1'
    );
    ...
    $options[] = array(
        ...
        'section'       => 'blog-section-archive',
        'transport'     => 'postMessage',
        'post_js'       => '$(".aux-archive .post .entry-main > .entry-info > .entry-date").auxToggle( to );',
        'type'          => 'switch',
        'dependency'  => array(
            array(
                 'id'      => 'display_post_info',
    ...
    $options[] = array(
        ...
        'section'       => 'blog-section-archive',
        'transport'     => 'postMessage',
        'post_js'       => '$(".aux-archive .post .entry-main > .entry-info > .meta-author").auxToggle( to );',
        'type'          => 'switch',
        'dependency'  => array(
            array(
                 'id'      => 'display_post_info',
    ...
    $options[] = array(
        ...
        'type'        => 'switch',
        'transport'   => 'postMessage',
        'post_js'       => '$(".aux-archive .post .entry-main > .entry-info > .entry-tax").auxToggle( to );',
        'default'     => '1'
    );
    ...
    $options[] = array(
        'title'       => __( 'Display Featured Image?', 'phlox' ),
        'description' => __( 'Whether to display featured image on blog archive page or not.', 'phlox' ),
    ...
    $options[] = array(
        ...
        'section'       => 'blog-section-taxonomy',
        'transport'     => 'postMessage',
        'post_js'       => '$(".aux-archive .post .entry-main > .entry-info > .author, .aux-archive .post .entry-main > .entry-info > .meta-author").auxToggle( to );',
        'type'          => 'switch',
        'dependency'  => array(
            array(
                 'id'      => 'display_post_taxonomy_info',
    ...
    $options[] = array(
        ...
        'dependency'    => array(),
        'post_js'       => '$(".page main.aux-single").alterClass( "*-sidebar", to );',
        'choices'       => array(
            'no-sidebar' => array(
                'label'     => __( 'No Sidebar', 'phlox' ),
                'css_class' => 'axiAdminIcon-sidebar-none'
    ...
    $options[] = array(
        ...
        'transport' => 'postMessage',
        'post_js'   => '$(".page .aux-primary .hentry").toggleClass( "aux-narrow-context", "boxed" == to );',
        'default'   => 'simple',
        'type'      => 'radio-image'
    );
    ...
    $options[] = array(
        ...
        'default'     => __( "&copy; {{Y}} {{sitename}}. All rights reserved.", 'phlox' ),
        'type'        => 'textarea'
    );

    $options[] = array(
        'title'       => __( 'Show Phlox attribution', 'phlox' ),
        'description' => __( 'Show the "Powered By Phlox" text with link to Phlox homepage in footer.', 'phlox' ),
        'id'          => 'attribution',
        'section'     => 'footer-section-footer',
        'dependency'  => array(
            array(
    ...
    $options[] = array(
        'title'       => __( 'Enbale Sticky Footer', 'phlox' ),
    ...
    $options[] = array(
        'title'       => __( 'Footer Background Color', 'phlox' ),
        ...
        'style_callback' => function( $value = null ){
            if( ! $value ){
                $value = esc_attr( auxin_get_option( 'site_footer_bg_color' ) );
            }
    ...
    $options[] = array(
        ...
        'description' => __( 'Specifies top border color of footer.', 'phlox' ),
        'section'     => 'footer-section-footer',
        'type'        => 'color',
        'dependency'  => array(
            array(
        ...
        'style_callback' => function( $value = null ){
            if( ! $value ){
                $value = esc_attr( auxin_get_option( 'footer_top_border_color' ) );
            }
