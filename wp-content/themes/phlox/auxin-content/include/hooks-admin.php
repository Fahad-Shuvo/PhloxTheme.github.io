...
function auxin_welcome_page_display_section_features(){
    ...
    <div class="feature-section one-col">
        <a href="http://support.averta.net/en/e-item/phlox-wordpress-theme/?b=33826,34922" class="aux-media-link" target="_blank"><img src="<?php echo esc_url( AUXIN_URL . 'images/welcome/laptop.png' ); ?>" alt="<?php esc_attr_e( "Get Started", 'phlox' ); ?>"></a>
    </div>
...
function auxin_welcome_page_display_section_support(){
    ...
    <div class="feature-section two-col">
        ...
        <div class="col">
            ...
            <a href="http://support.averta.net/en/e-item/phlox-wordpress-theme/?b=33826,34922" class="button button-primary aux-button" target="_blank"><?php esc_html_e('Visit Documentation', 'phlox'); ?></a>
        </div>
    </div>
     <div class="feature-section two-col">
         <div class="col">
        ...
        <div class="col">
            ...
            <a href="http://support.averta.net/en/item/phlox/" class="button button-primary aux-button" target="_blank"><?php esc_html_e('Submit a Ticket', 'phlox'); ?></a>
        </div>
    </div>
    <div class="feature-section two-col">
        <div class="col">
