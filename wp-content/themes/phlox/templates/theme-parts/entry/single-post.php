<?php global $post;
    ...
    // whether to ignore the media or not
    if( 'default' === $show_single_media = auxin_get_post_meta( $post->ID, 'blog_single_show_media', 'default' ) ){
        $show_single_media = auxin_get_option( 'show_post_single_media' );
    }
    $show_single_media = auxin_is_true( $show_single_media );

    $post_vars = auxin_get_post_format_media(
        $post,
        array(
            'request_from' => 'single',
            'ignore_media' => ! $show_single_media
        )
    );
    ...
    $post_content_style      = auxin_get_post_meta( $post, 'post_content_style', 'default' );
...
?>
                                    <article <?php post_class( $post_extra_classes ); ?> >
                                            ...
                                            <?php if ( $show_single_media && $has_attach ) : ?>
