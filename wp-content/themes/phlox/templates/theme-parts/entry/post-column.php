                        ...
                        <article <?php post_class( $post_classes ); ?>>
                            ...
                            <?php ob_start(); ?>
                                ...
                                <?php
                                if( $display_title || 'quote' == $post_format) {
                            ...
                            if( 'quote' !== $post_format && $show_info ) {
                            ...
                            ?>
                                ...
                                <?php if ( $display_categories ) {
                                    $tax_class_name = ! $show_date ? 'aux-no-sep' : '';
                                ?>
                            ...
                            <?php if( $show_readmore || $show_author_footer ) {?>
                                <footer class="entry-meta">
                                    ...
                                    <div class="comments-iconic">
                                        <?php
                                            if( $display_like ){
                                                if(function_exists('wp_ulike')) wp_ulike( 'get', array( 'style' => 'wpulike-heart' ) );
                                            }
                                        ?>
                                    ...
                                    <?php
                                    } elseif( $display_like && (function_exists('wp_ulike') ) ){ ?>
                                    <div class="comments-iconic">
