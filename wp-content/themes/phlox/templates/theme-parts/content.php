<?php $is_pass_protected = post_password_required(); ?>
                ...
                <?php if ( ! $is_pass_protected ) : ?>
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            <footer>
                                <?php the_tags('<p class="tags"><span class="tags-title">' . esc_html__("Tags", 'phlox') . ':</span> ', ', ', '</p>'); ?>
                        ...
                        <article id="post-not-found">
                            <header>
                                <h1><?php esc_html_e("Not Found", 'phlox'); ?></h1>
                            </header>

                            <section class="entry-content">
                                <p><?php esc_html_e("Sorry, but the requested resource was not found on this site.", 'phlox'); ?></p>
                            </section>
